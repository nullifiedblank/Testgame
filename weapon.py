...
from assets import ASSETS # Import the global assets dictionary
...
class Laser(pygame.sprite.Sprite):
    def __init__(self, player, lifetime, damage):
        ...
        pygame.draw.rect(self.image_orig, (255,0,0), (0,0,5,1000)); self.image = self.image_orig; self.rect = self.image.get_rect(midbottom=player.rect.center)
...
class WeaponData:
    def __init__(self, held_image_path, attack_type, attack_cooldown, combo_reset_time, attack_data, attack_sprite_class=None, **kwargs):
        ...
        self.attack_data = attack_data # Now just stores the dicts with paths
